# @title ## 2. 런처 앱 ##
VERSION = "v0.4.8"  # @param {type:"string"}
...
FAVORITES_COMMITS = [
    [
        "2023-08-23 v1.5.2[⧉](https://github.com/AUTOMATIC1111/stable-diffusion-webui/commit/c9c8485bc1e8720aba70f029d25cba1c4abf2b5c)"
    ],
    [
